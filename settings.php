    ...
    <section class="absolute top-0 left-0 flex items-center" id="sidebar">
        <div class="container">
            <div id="sidebar-hidden"
                class="hidden lg:flex flex-col bg-primary w-[40vw] md:w-[25vw] lg:w-[20vw] xl:w-[17vw] 2xl:w-[15vw] h-[100vh] fixed z-10 rounded-tr-[32px] rounded-br-[32px]">
                            ...
                            <li class="flex flex-col py-[25px] group">
                                <a href="" class="flex flex-row items-center">
                                    <div
                                        ...
                                        <svg class="stroke-current w-current h-current" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                d="M20 14.7C19.5339 17.0141 18.186 19.0561 16.2414 20.3942C14.2967 21.7323 11.9078 22.2616 9.58001 21.87C5.79001 21.26 2.74 18.21 2.12 14.42C1.73276 12.0983 2.26019 9.71681 3.59155 7.77571C4.92291 5.83461 6.95461 4.48489 9.26001 4.00999"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </div>
                        ...
                        <ul>
                            <li class="flex flex-col py-[25px]">
                                <a href="settings.php" class="flex flex-row items-center text-white">
                                    <div
                                        class="w-[20px] h-[20px] md:w-[24px] md:h-[24px] 2xl:w-[26px] 2xl:h-[26px] mr-4">
                            ...
                            <li class="flex flex-col py-[25px] group mb-14">
                                <a href="logout.php" class="flex flex-row items-center"
                                    ...
                                    <div
                                        class="w-[20px] h-[20px] md:w-[24px] md:h-[24px] 2xl:w-[26px] 2xl:h-[26px] text-lightGray group-hover:text-white mr-4">
                                        <svg class="stroke-current w-current h-current" fill="none" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
        ...
        <div class="container">
            <div class="flex items-center overflow-hidden justify-between z-10 h-[68px]">
                ...
                <div id="header-active" class="flex justify-center items-center text-xs ml-4">
                    <button id="hamburger-menu" name="hamburger-menu" type="button"
                        class="text-textColor mr-4 lg:hidden">
                ...
                <div class="flex justify-center items-center md:mr-8 2xl:mr-4">
                    ...
                    <div class="mr-4 md:mr-3">
                        <img src="img/profil.jpg" class="w-[40px] h-[40px] md:w-[50px] md:h-[50px] rounded-full"
                            alt="Profil">
                    </div>
                    ...
                    <main class="lg:ml-[15rem] flex flex-col justify-center items-center">
                        <div id="dashboard-layout" class="flex flex-col">
                            <div class="flex flex-col justify-center items-center">
                                ...
                                <div id="box-kolam"
                                    class="w-[95vw] lg:w-[74vw] xl:w-[78vw] bg-white mb-4 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                        <h4 class="font-medium text-[14px] md:text-base text-[#cccccc]">Data Ikan</h4>
                                        <span class="w-5 h-5 md:w-6 md:h-6 text-[#cccccc]">
                                            <svg viewBox="0 0 24 24" class="stroke-current" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <div class="flex items-center justify-center md:justify-start">
                                                <form action="" method="post" class="flex flex-col w-full">
                                                        ...
                                                        <li>
                                                            ...
                                                            <label for="tanggalTebar"
                                                                ...
                                                                <div class="flex justify-center items-center mt-2">
                                                                    ...
                                                                    <input type="date" id="tanggalTebar"
                                                                        name="tanggalTebar"
                                                                        placeholder="Berat ikan (gram)"
                                                                        class="px-3 py-2 shadow border border-[#cccccc] rounded-full w-full block text-sm ml-2"
                                                                        required>
                                                        ...
                                                        <li>
                                                            ...
                                                            <label for="tanggalMenguras"
                                                                ...
                                                                <div class="flex justify-center items-center mt-2">
                                                                    ...
                                                                    <input type="date" id="tanggalMenguras"
                                                                        name="tanggalMenguras"
                                                                        placeholder="Berat ikan (gram)"
                                                                        class="px-3 py-2 shadow border border-[#cccccc] rounded-full w-full block text-sm ml-2"
                                                                        required>
                                                                </div>
                                                        ...
                                                        <li>
                                                            ...
                                                            <label for="tanggalPindah"
                                                                ...
                                                                <div class="flex justify-center items-center mt-2">
                                                                    ...
                                                                    <input type="date" id="tanggalPindah"
                                                                        name="tanggalPindah"
                                                                        placeholder="Berat ikan (gram)"
                                                                        class="px-3 py-2 shadow border border-[#cccccc] rounded-full w-full block text-sm ml-2"
                                                                        required>
                                                    ...
                                                    <button type="submit" name="submitData"
                                                        class="w-full h-10 bg-primary text-white rounded-full mt-6 font-semibold">Tambah</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="box-kolam"
                                    class="w-[95vw] lg:w-[74vw] xl:w-[78vw] bg-white p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="flex items-center justify-center md:justify-start">
                                                <form action="" method="post" class="flex flex-col w-full">
                                                        ...
                                                        <li>
                                                            ...
                                                            <label for="bobot"
                                                                ...
                                                                <div class="flex justify-center items-center mt-2">
                                                                    ...
                                                                    <input type="number" id="bobot" name="bobotPakan"
                                                    ...
                                                    <button type="submit" name="submitWaktu"
                                                        class="w-full h-10 bg-primary text-white rounded-full mt-6 font-semibold">Tambah</button>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div id="box-tabel-data"
                                    class="w-[95vw] lg:w-[74vw] xl:w-[78vw] mt-4 bg-white p-4 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                    ...
                                    <!-- Tabel Waktu Pakan -->
                                    <div
                                        class="flex justify-center items-center mt-4 w-full overflow-x-scroll md:overflow-auto rounded-lg shadow">
                                        <table id="tabel"
                                            class="table-auto border border-solid text-xs md:text-[14px] w-full">
                                                    ...
                                                    <td class="p-1 full-w">
                                                        <div
                                                            ...
                                                            <div class="flex justify-center items-center py-1">
                                                                <a href="./src/ubah.php?id=<?= $data["id"]; ?>"
                                                                    class="bg-primary px-3 py-1 rounded text-white mr-1 show-modal font-semibold">Ubah</a>
