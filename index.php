...
// Query Database
$dataKolamLast = queryDataKolam("SELECT * FROM datakolam ORDER BY id DESC LIMIT 1")[0];
$waktuPakan = queryWaktuMakan("SELECT * FROM waktumakan");
$stokMakanan = queryWaktuMakan("SELECT * FROM waktumakan ORDER BY id DESC LIMIT 1");

json_encode($waktuPakan);
json_encode($stokMakanan);
?>
...
<body class="bg-bgColor">
    ...
    <section class="absolute top-0 left-0 flex items-center" id="sidebar">
        <div class="container">
            ...
            <div id="sidebar-black-screen" class="hidden ml-[32vw] md:ml-[20vw] w-[70vw] md:w-[80vw] bg-primary opacity-40 h-[100vh] fixed z-45"></div>
        </div>
    </section>
    <!-- Sidebar Section End -->
    ...
    <section class="absolute top-0 left-0 w-full flex item-center bg-white shadow-lg" id="header">
        <div class="container">
            <div class="flex item-center overflow-hidden justify-between 2xl:justify-end z-10 h-[68px]">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center">
                    ...
                    <main class="lg:ml-[15rem] 2xl:ml-[16rem] flex flex-col justify-center items-center">
                        <div id="dashboard-layout" class="flex flex-col xl:flex-row">
                            <div>
                                <!-- Kotak Kolam -->
                                <div id="box-kolam" class="w-[95vw] md:w-[93vw] lg:w-[74vw] xl:w-[330px] xl:h-[480px] 2xl:w-[380px] 2xl:h-[500px] bg-white md:ml-2 lg:ml-0 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                        ...
                                        <div id="statistik-ikan" class="flex w-3/4 mt-4 md:mt-6 justify-between items-center">
                                            <div class="flex flex-col justify-center items-center">
                                                ...
                                                <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                    <p class="font-semibold text-[14px] md:text-base"><?= $dataKolamLast["jumlah"] ?> ekor</p>
                                                <?php else : ?>
                                                    <p class="font-semibold text-[14px] md:text-base">-</p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="flex flex-col justify-center items-center">
                                                <h3 class="font-medium text-[14px] md:text-base">Ukuran</h3>
                                                <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                    <p class="font-semibold text-[14px] md:text-base"><?= $dataKolamLast["ukuran"] ?> cm</p>
                                                <?php else : ?>
                                                    <p class="font-semibold text-[14px] md:text-base">-</p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="flex flex-col justify-center items-center">
                                                ...
                                                <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                    <p class="font-semibold text-[14px] md:text-base"><?= $dataKolamLast["beratIkan"] ?> gram</p>
                                                <?php else : ?>
                                                    <p class="font-semibold text-[14px] md:text-base">-</p>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <table>
                                                <tr class="mb-2">
                                                    ...
                                                    <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                        ...
                                                        <?php
                                                        $tanggalTebarparse = date_parse($dataKolamLast["tanggalTebar"]);
                                                        ...
                                                        <td class="font-medium text-[14px] md:text-base"><?= $tanggalTebarConcat; ?></td>
                                                    <?php else : ?>
                                                        <td class="font-medium text-[14px] md:text-base">-</td>
                                                    <?php endif; ?>
                                                </tr>
                                                <tr class="mb-2">
                                                    ...
                                                    <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                        ...
                                                        <?php
                                                        $tanggalMengurasparse = date_parse($dataKolamLast["tanggalMenguras"]);
                                                        ...
                                                        ?>
                                                        <!-- Tampilan tanggalTebar End -->
                                                        <td class="font-medium text-[14px] md:text-base"><?= $tanggalMengurasConcat; ?></td>
                                                    <?php else : ?>
                                                        <td class="font-medium text-[14px] md:text-base">-</td>
                                                    <?php endif; ?>
                                                </tr>
                                                <tr class="mb-2">
                                                    ...
                                                    <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                        ...
                                                        <?php
                                                        $tanggalPindahparse = date_parse($dataKolamLast["tanggalPindah"]);
                                                        ...
                                                        ?>
                                                        <!-- Tampilan tanggalTebar End -->
                                                        <td class="font-medium text-[14px] md:text-base"><?= $tanggalPindahConcat; ?></td>
                                                    <?php else : ?>
                                                        <td class="font-medium text-[14px] md:text-base">-</td>
                                                    <?php endif; ?>
                                                </tr>
                                            ...
                                            <table>
                                                ...
                                                <tr class="mb-2">
                                                    ...
                                                    <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                                        ...
                                                        <?php
                                                        $createdParse = date_parse($dataKolamLast["created"]);
                                                        ...
                                                        <td class="font-medium text-[13px] md:text-base"><?= $createdConcat; ?>
                                                        </td>
                                                    <?php else : ?>
                                                        <td class="font-medium text-[13px] md:text-base">-</td>
                                                    <?php endif; ?>
                                                </tr>
                                            </table>
                                        </div>
                            ...
                            <div class="xl:flex xl:flex-wrap xl:gap-y-6">
                                <!-- Kotak Makanan -->
                                <div id="box-makanan" class="w-[95vw] md:w-[93vw] lg:w-[74vw] xl:w-[330px] 2xl:w-[360px] mt-6 xl:mt-0 bg-white md:ml-2 lg:ml-0 xl:ml-4 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                ...
                                <!-- Suhu -->
                                <div id="box-suhu" class="w-[95vw] md:w-[93vw] lg:w-[74vw] xl:w-[330px] 2xl:w-[360px] mt-6 xl:mt-0 bg-white md:ml-2 lg:ml-0 xl:ml-4 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="mt-2">
                                        <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                            <?php if ($dataKolamLast["suhu"] == null) : ?>
                                                <h3 class="font-bold text-[16px] md:text-[24px] text-textColor">-°C</h3>
                                            <?php else : ?>
                                                <h3 class="font-bold text-[16px] md:text-[24px] text-textColor"><?= $dataKolamLast["suhu"]  ?>°C</h3>
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <h3 class="font-bold text-[16px] md:text-[24px] text-textColor">-°C</h3>
                                        <?php endif; ?>
                                ...
                                <!-- pH -->
                                <div id="box-ph" class="w-[95vw] md:w-[93vw] lg:w-[74vw] xl:w-[330px] 2xl:w-[360px] mt-6 xl:mt-0 bg-white md:ml-2 lg:ml-0 xl:ml-4 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="mt-2">
                                        <?php if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datakolam")) > 0) : ?>
                                            <?php if ($dataKolamLast["ph"] == null) : ?>
                                                <h3 class="font-bold text-[16px] md:text-[24px] text-textColor">- pH</h3>
                                            <?php else : ?>
                                                <h3 class="font-bold text-[16px] md:text-[24px] text-textColor"><?= $dataKolamLast["ph"]  ?> pH</h3>
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <h3 class="font-bold text-[16px] md:text-[24px] text-textColor">-°C</h3>
                                        <?php endif; ?>
                                ...
                                <!-- Catatan -->
                                <div id="box-catatan" class="w-[95vw] md:w-[93vw] lg:w-[74vw] xl:w-[330px] 2xl:w-[360px] mt-6 xl:mt-0 bg-white md:ml-2 lg:ml-0 xl:ml-4 p-3 md:p-6 rounded-lg md:rounded-xl shadow-md md:shadow-lg">
                                    <div class="flex justify-between items-center">
