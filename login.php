...
<body class="bg-bgColor">
    <div class="container">
        <div class="flex flex-wrap justify-center items-center xl:w-full xl:h-screen">
            ...
            <div class="w-full self-center xl:hidden">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <h3 class="text-base text-primary">Masuk ke akun Anda !</h3>
                        <?php if (isset($error)) : ?>
                ...
                <form action="" method="post">
                    ...
                    <div class="flex justify-center items-start mt-10">
                        <button class="w-[128px] bg-primary text-white rounded-full p-1 ml-2" type="submit" name="login">Masuk</button>
                    </div>
                </form>
                <!-- Form Registrasi End -->
                ...
                <div class="flex justify-center items-start mt-8">
                    <p class="text-[14px]">
                    Belum punya akun ? <a class="text-[14px] text-primary font-bold" href="registrasi.php">Daftar di sini</a>
                    </p>
                </div>
            </div>
            <!-- Mobile, sm, md, lg breakpoint -->
            ...
            <!-- xl, 2xl breakpoint -->
            <div class="w-[80vw] h-[40rem] rounded-xl shadow-lg hidden xl:flex flex-col bg-white bg-opacity-95 self-center">
                    ...
                    <div class="flex flex-col justify-center items-start">
                        ...
                        <div class="flex justify-start items-center">
                            <div class="flex flex-col justify-center items-start">
                                <div class="flex flex-col justify-center items-start">
                                    ...
                                    <h3 class="text-base xl:text-[20px] text-primary">Masuk ke akun Anda !</h3>
                                    <?php if (isset($error)) : ?>
                        ...
                        <div class="flex flex-col justify-center items-center mt-[46px]">
                            ...
                            <div class="flex justify-center items-center mt-10">
                                <button class="w-[156px] bg-primary text-white font-semibold text-[20px] rounded-full p-1 ml-2" type="submit" name="login">Masuk</button>
                            </div>
        
                            <div class="flex justify-center items-center mt-8">
                                <p class="text-[14px] xl:text-[16px]">
                                    Belum punya akun ? <a class="text-[14px] xl:text-[16px] text-primary font-bold" href="registrasi.php">Daftar di sini</a>
                                </p>
                            </div>
                        </div>
                    </div>
